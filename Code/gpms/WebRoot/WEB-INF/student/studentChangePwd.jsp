...
<body>
	<section id="container">
		<header id="header">
			<!--logo start-->
			<div class="brand">
				<a href="index.html" class="logo"> <span>学生界面</span>
				</a>
			</div>
			<!--logo end-->
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" class="form-horizontal" action="${pageContext.request.contextPath }/changePwd.do" method="post">
									<div class="form-group">
										<label class="col-sm-4 control-label" for="inputPassword3">旧密码：</label>
										<div class="col-sm-5">
											<input type="password" placeholder="Password"
												id="inputPassword2" class="form-control" name="oldPwd">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 control-label" for="inputPassword3">新密码：</label>
										<div class="col-sm-5">
											<input type="password" placeholder="Password" id="newPwd1"
												class="form-control" name="newPwd">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-4 control-label" for="inputPassword3">确认新密码：</label>
										<div class="col-sm-5">
											<input type="password" placeholder="Password" id="newPwd2"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
