						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div id="accordion" class="panel-group accordion">
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title col-sm-8">
												<a href="#collapseTwo" data-parent="#accordion"
													data-toggle="collapse" class="collapsed"><b><h4>选题1002：计信学院综合管理系统------学生事务管理模块</h4>
												</b>
												</a>
											</h4>
											<h4 class="panel-title col-sm-offset-2 col-sm-2">
												<b><h4>出题人：张挺</h4>
												</b>
											</h4>
										</div>
										...
										<div class="panel-heading">
											<h4 class="panel-title col-sm-8">
												<a href="#collapseThree" data-parent="#accordion"
													data-toggle="collapse" class="collapsed"><b><h4>选题1003：计信学院综合管理系统------学生事务管理模块</h4>
												</b>
												</a>
											</h4>
											<h4 class="panel-title col-sm-offset-2 col-sm-2">
										...
										<div class="panel-heading">
											<h4 class="panel-title col-sm-8">
												<a href="#collapseFour" data-parent="#accordion"
													data-toggle="collapse" class="collapsed"><b><h4>选题1004：计信学院综合管理系统------学生事务管理模块</h4>
												</b>
												</a>
											</h4>
											<h4 class="panel-title col-sm-offset-2 col-sm-2">
