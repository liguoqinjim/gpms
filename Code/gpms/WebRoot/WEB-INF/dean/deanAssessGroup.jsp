				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li>评阅教师分组</li>
							<li class="active">评阅教师分组</li>
						</ul>
						<!--breadcrumbs end -->
						<h1 class="h1">评阅教师分组</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" class="form-horizontal"
									action="${pageContext.request.contextPath }/accessGroup.do"
									method="post">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" class="form-horizontal">
									<c:if test="${!empty teacherGroupsWeb }">
									<c:forEach items="${teacherGroupsWeb }" var="teacherGroupWeb"
										varStatus="status">
										<c:choose>
											...
											<c:when test="${status.count==1||status.count==2 }">
												<div class="form-group">
													<div class="col-md-2">
														<label class="control-label" style="font-size:30px;">第
															${status.count } 组</label>
													</div>
					<c:forEach items="${teacherGroupWeb.teacherGroups}" var="teacherGroup" varStatus="statusi">
														<div class="col-md-2">
															<button class="btn btn-primary btn-lg" type="button"
																style="width: 90%">${statusi.count
																}：${teacherGroup.teacher.teacherName }</button>
																</div>
										         	</c:forEach>
												</div>
										    	</c:when>
											...
											<c:otherwise>
												<div class="form-group">
													...
													<c:forEach items="${teacherGroupWeb.teacherGroups }"
														var="teacherGroup" varStatus="statusi">
														<div class="col-md-2">
															<button class="btn btn-primary btn-lg" type="button"
																style="width: 90%">${statusi.count
																}：${teacherGroup.teacher.teacherName }</button>
