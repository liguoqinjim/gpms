				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li><a href="#">首页</a></li>
							<li>确定学生选题</li>
							<li class="active">确定一二轮选题</li>
						</ul>
						<!--breadcrumbs end -->
						<h1 class="h1">确定一二轮选题</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" class="form-horizontal"  action="${pageContext.request.contextPath }/confirmSubject.do" method="post">
									<div class="form-group">
										<label class="col-sm-2 control-label">确定第一轮选题：</label>
										<div class="col-md-5">
											<input type="hidden" value="1" name="volunteerTurn">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" class="form-horizontal" action="${pageContext.request.contextPath }/confirmSubject.do" method="post">
									<div class="form-group">
										<label class="col-sm-2 control-label">确定第二轮选题：</label>
										<div class="col-md-5">
											<input type="hidden" value="2" name="volunteerTurn">
											<input type="submit" class="btn btn-primary" value="确定" />
										</div>
									</div>
								</form>
