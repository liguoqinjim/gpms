				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li><a href="#">首页</a></li>
							<li>数据导入</li>
							<li class="active">班级数据导入</li>
						</ul>
						<!--breadcrumbs end -->
						<h1 class="h1">班级数据导入</h1>
					</div>
				</div>
					...
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<form
									action="${pageContext.request.contextPath }/adminUpload.do?flag=uploadClazz"
							...
							<div class="panel-body">
								<table class="table">
									...
									<tbody>
										...
										<c:if test="${! empty clazzs }">
											<c:forEach items="${clazzs }" var="clazz" varStatus="status">
												<c:choose>
												...
												<td>${clazz.clazzGrade }</td>
												<td>${clazz.clazzMajor }</td>
												</tr>
											</c:forEach>
										</c:if>
									</tbody>
								...
								<div class="col-sm-offset-11 col-sm-1">
									<button class="btn btn-primary" type="button"
										onclick="window.location.href='${pageContext.request.contextPath }/uploadClazz.do'">
										导入</button>
								</div>
							</div>
						</div>
