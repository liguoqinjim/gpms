				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							...
							<li>录入功能</li>
							<li class="active">输入学生初评成绩和意见</li>
						</ul>
						<!--breadcrumbs end -->
						<h1 class="h1">输入学生初评成绩和意见</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<form role="form" class="form-horizontal" method="post"
									action="${pageContext.request.contextPath }/inputFirstAssess.do">
											...
											<select class="form-control input-sm" name="studentId">
												<c:if test="${! empty students } }">
													<c:forEach item="${students }" var="student"
														varStatus="status">
														<option value="${student.id}">${student.studentName
															} &nbsp; ${student.id }</option>
													</c:forEach>
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="inputPassword3">初评成绩：</label>
										<div class="col-sm-5">
											<input type="text" name="studentScore">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">初评意见：</label>
										<div class="col-sm-8">
											<textarea class="form-control" name="studentComment"></textarea>
										</div>
									</div>
									<div class="form-group">
