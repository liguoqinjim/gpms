				...
				<ul>
					<li class="dropdown settings"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu animated fadeInDown">
							<li><a
								href="${pageContext.request.contextPath }/teacherUrl.do?flag=teacherCalendar"><i
									class="fa fa-calendar"></i> Calendar</a></li>
							<li><a
								href="${pageContext.request.contextPath }/teacherUrl.do?flag=teacherLogout"><i
					...
					<div class="row">
						<div class="col-md-offset-1 col-md-2" id="events">
							...
							<div id="external-events">
								...
								<div class="checkbox">
									<input type="checkbox" value="1" id='drop-remove'> <label
						...
						<div class="col-md-8" id="cal">
							<div class="full-cal-header">
								<div class="pull-left">
									<div class="btn-group ">
										<button class="btn btn-info" id="cal-prev">
											<i class="fa fa-angle-left"></i>
										</button>
										<button class="btn btn-info" id="cal-next">
