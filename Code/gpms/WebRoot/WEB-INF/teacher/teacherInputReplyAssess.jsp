				...
				<div class="row">
					<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li><a href="#">首页</a></li>
							<li>录入功能</li>
							<li class="active">输入学生答辩成绩和意见</li>
						</ul>
						<!--breadcrumbs end -->
						<h1 class="h1">输入学生答辩成绩和意见</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<form role="form" class="form-horizontal">
									...
									<div class="form-group">
										<label class="col-sm-2 control-label" for="inputPassword3">答辩成绩：</label>
										<div class="col-sm-5">
											<input type="text" name="studentScore">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">答辩意见：</label>
										<div class="col-sm-8">
